          ...
          <section className="section">
            <div class="section-header">
              ...
              <div class="section-header-button">
                <a href="#" class="btn btn-primary" onClick={() => this.Add()}>
                  <i className="fas fa-plus-square "></i> Add Admin
                </a>
              </div>
                              ...
                              <tr key={index}>
                                ...
                                <td className="col-lg-4">
                                  <div className="buttons">
                                    <a
                                      href="#"
                                      className="btn btn-icon icon-left btn-lg btn-primary rounded-pill"
                                    ...
                                    <a
                                      href="#"
                                      className="btn btn-icon icon-left btn-lg btn-danger rounded-pill"
                                      onClick={() =>
                                        this.dropAdmin(item.id_admin)
                                      }
                                    >
                    ...
                    {this.state.action === "insert" ? (
                      ...
                      <Form.Group className="mb-3" controlId="id_outlet">
                        ...
                        <Form.Select
                          ...
                          required
                        >
                          <option value={this.state.id_outlet}>
