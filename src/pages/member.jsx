                ...
                <div className="main-content">
                    <section className="section">
                        ...
                        <Modal show={
                            ...
                            <Form className="bg-light bg-opocity-10"
                                onSubmit={
                                    e => this.handleSave(e)
                            }>
                                <Modal.Body>
                                    ...
                                    <Form.Group className="mb-3 text-dark bg-transparent" controlId="name">
                                        <Form.Label className="text-sm">Member Name
                                        </Form.Label>
                                        <Form.Control className="text-dark bg-transparent" type="text" name="nama" placeholder="Masukkan Nama"
                                            value={
                                                this.state.nama
                                            }
                                            onChange={
                                    ...
                                    <Form.Group className="mb-3" controlId="address">
                                        ...
                                        <Form.Select className="text-dark bg-transparent" type="text" name="gender"
                                            value={
                                                this.state.gender
                                            }
                                            onChange={
                                    ...
                                    <Form.Group className="mb-3" controlId="phone">
                                        ...
                                        <Form.Control className="text-dark bg-transparent" type="text" name="phone" placeholder="Masukkan Phone Number"
                                            value={
                                                this.state.phone
                                            }
                                            onChange={
                                    ...
                                    <Form.Group className="mb-3" controlId="username">
                                        ...
                                        <Form.Control className="text-dark bg-transparent" type="text" name="username" placeholder="Masukkan  Username"
                                            value={
                                                this.state.username
                                            }
                                            onChange={
                                    ...
                                    <Form.Group className="mb-3" controlId="password">
                                        ...
                                        <Form.Control className="text-dark bg-transparent" type="password" name="password" placeholder="Masukkan Password"
                                            value={
                                                this.state.password
                                            }
                                            onChange={
